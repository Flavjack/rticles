...
source("http://lozanoisla.com/rticles.r")
...
gs %>% 
  ...
  select(rep:D5) %>% 
  head(10) %>% 
  kable(caption = "Germination dataset import from a googlesheet")
...
include_graphics("files/fig_gerplot.png")
...
download.file(
  url = "https://raw.githubusercontent.com/Flavjack/rticles/master/files/fig_jc.jpg"
  , destfile = "files/fig_jc.jpg", mode = "wb")
...
include_graphics("files/fig_jcurcas.png")
...
<embed src="files/mensh_&_kording_2017.pdf" width="100%" height="600" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
